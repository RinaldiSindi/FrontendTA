      ...
      >
          ...
          <div className=" ">
            <div className="max-w-xl ">
              ...
              <p className="mt-4 max-w-lg sm:text-lg/relaxed text-slate-700">
                Berbagi pengetahuan, membuka peluang, dan jadilah bagian dari gerakan
        ...
        <section className="">
          ...
          <p className="text-base text-center">
            Togetherboost berkomitmen untuk membantu pendidikan bagi setiap individu
            yang membutuhkan
          </p>
          ...
          <div className="flex flex-col md:flex-row  justify-between gap-2 py-10">
            <Featured
              text="Menumbuhkan ketertarikan untuk belajar"
              description="Kami berkomitmen untuk menumbuhkan ketertarikan belajar bagi siapa saja yang membutuhkan"
              icon={<TbRocket />}
            />
            <Featured
              text="Mendukung pendidikan untuk mereka yang memerlukan"
            ...
            />
            <Featured
              text="Membuka peluang untuk berperan dalam pendidikan"
