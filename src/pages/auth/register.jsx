              ...
              >
                ...
                <div className="col-span-6">
                  ...
                  <input
                    ...
                    name="profession"
                    className="mt-1 w-full rounded-md border-gray-200 bg-white text-sm text-gray-700 shadow-sm"
                    placeholder="SMA Muhammadiyah Bandung, UM Bandung, dan lainnya "
                    {...register("profession")}
                  />
                  {errors.email && (
                ...
                <div className="col-span-6 sm:flex sm:items-center sm:gap-4">
                  <button
                    type="submit"
                    className="inline-block shrink-0 rounded-md border border-cyan-600 bg-cyan-700 px-12 py-3 text-sm font-medium text-white transition hover:bg-transparent hover:text-cyan-600 focus:outline-none focus:ring active:text-cyan-500"
                    disabled={isLoading}
                  >
