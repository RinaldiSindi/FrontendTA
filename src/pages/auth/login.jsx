    ...
    <>
      <section className="relative flex flex-wrap lg:h-screen lg:items-center">
        <div className="w-full px-4 py-12 sm:px-6 sm:py-16 lg:w-1/2 lg:px-8 lg:py-24">
          ...
          >
            ...
            <div className="flex items-center justify-between">
              <button
                type="submit"
                className="inline-block w-full rounded-lg bg-cyan-700 px-5 py-3 text-sm font-medium text-white hover:bg-cyan-600 duration-200"
              >
                {isLoading ? (
        ...
        <div className="relative bg-cyan-600 h-64 w-full sm:h-96 lg:h-full lg:w-1/2 flex flex-col justify-center items-center">
          ...
          />
          <p className="mt-64 text-white text-center text-4xl font-bold sm:text-4xl">
            Berbagi informasi untuk bantu pendidikan!
          </p>
        </div>
      </section>
      <ToastContainer />
