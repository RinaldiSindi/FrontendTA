        ...
        <div className="flex  relative">
          ...
          <div>
            ...
            <span className="text-xs font-normal text-gray-400">
              Diposting oleh : {savedLocation ? "Pengguna" : name}
            </span>
          </div>
        ...
        <div>
          ...
          <div className=" sm:flex justify-between items-center">
            ...
            <Link
              ...
              className="block bg-cyan-600 px-5 py-3 text-center text-xs font-bold uppercase text-white transition hover:bg-cyan-500 duration-200"
            >
              Read More
            </Link>
          </div>
