        ...
        <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-lg">
            <h4 className="text-center text-lg font-medium sm:text-2xl">
              {editPath ? "Edit Donasi" : "Buat Postingan Informasi Beasiswa"}
            </h4>
            ...
            <form
              ...
              className="mb-0 mt-4 space-y-4 rounded-lg p-4 shadow-lg sm:p-6 lg:p-8 border-t-4 border-cyan-600"
            >
              <div>
                <label className="sr-only">Judul</label>
                <div className="relative">
                  <input
                    className={`w-full rounded-lg border-gray-200 focus:border-cyan-600 ${
              ...
              <div>
                ...
                <span className="text-sm text-gray-600">Contoh: https://forms.gle/AM1GREAJHr5aEUTB8</span>
              </div>
              ...
              <button
                type="submit"
                className="block w-full rounded-lg bg-cyan-600 px-5 py-3 text-sm font-medium text-white hover:bg-cyan-500 duration-200"
              >
